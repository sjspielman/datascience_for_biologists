...
`cp` | **C**o**p**y a file or directory (_original file unchanged_) | `cp oldfile.txt newfile.txt` <br> `cp oldfile.txt .. # make a copy of the file to live one directory up`
