...
6. A meaningful title. You can add plot titles either with the added argument `title` to the `labs()` function, or using the separate function `ggtitle()`. Check out the help menus to learn more!!
