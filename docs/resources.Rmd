...
+ [Introduction to data types](https://rowanbiosci.shinyapps.io/datatypes/)
+ [Understanding the different types of plots](https://rowanbiosci.shinyapps.io/types_of_plots/)
+ [Types of figures and their relationship to data](https://rowanbiosci.shinyapps.io/data_figures/)
...
## Tutorials from Dr. Spielman

+ [Introduction to R tutorial](./tutorials/introduction_to_R.html)
+ [`dplyr` one-table verbs](./tutorials/dplyr_onetable.html)
