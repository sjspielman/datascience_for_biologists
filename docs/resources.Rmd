...
+ [Twitter for Scientists](https://t4scientists.com/) and  [Twitter for R Programmers](https://www.t4rstats.com/)
  + An excellent and thorough introductions to using twitter and interacting with the extreme;y wonderful `#rstats` community
...
+ [STAT545 Resources (**EXCELLENT** background)](https://stat545.com/)
  ...
  + Recommended book sections:
    ...
    + [When one tibble is not enough](https://stat545.com/multiple-tibbles.html) **Note: We may not get to this topic during Spring 2021 due to remote instruction limitations.**
...
+ [Introduction to `ggplot2` exercises](https://rowanbiosci.shinyapps.io/intro_ggplot/)
...
+ [All the R colors you ever wanted to use!!](https://github.com/sjspielman/datascience_for_biologists/raw/master/spring2020/rmd_lessons/static/Rcolor.pdf)
...
## Other static tutorials from Dr. Spielman
