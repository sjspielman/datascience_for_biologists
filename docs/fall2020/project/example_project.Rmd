...
#### Answer
This regression yielded an $R^2 = 0.01637$ with a P-value of 0.0002. These results suggest that processing method, while significant, is not a strong predictor of coffee flavor, but is actually a very weak predictor. The mean flavor for "Natural/Dry" coffees is 7.59. The model reports that that the flavor score for "Washed/Wet" coffees is, on average, 0.105 lower than "Natural/Dry" coffees (P=1.94e-5). Similarly, "Other" coffee flavors are, on average, 0.14 points lower than are "Natural/Dry" coffees (P=0.0365). There is no statistical evidence that "Pulped natural/honey" or "Semi-washed / Semi-pulped" have different average flavors from "Natural/Dry". This result is exemplified in the figure, which shows highly similar means among flavor distributions.
