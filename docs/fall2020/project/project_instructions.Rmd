...
+ **20 points for each** successfully-completed question and answer (total 80 points)
  ...
  + Your modeling answer must incorporate...
    + Linear regression: Plots to check assumptions and a final plot of the model (if you have too many predictors to visualize in one plot, *make sure you talk to Spielman about what to do*)
    + Logistic regression: ROC curve AND logistic curve itself
