...
Below are linked examples for roughly how you are expected to do the proposal and project. The project example is limited to 2 questions for simplicity.

+ Please refer to [this example proposal]() to see the target scope for the proposal.
  + Its source Rmarkdown file is available [here](). 
  + *Hint:* You can use this to see how to insert your Rmarkdown theme, and more!

+ Please refer to [this example project]() to see the target scope for the project.
  + Its source Rmarkdown file is available [here](). 
