...
|Discrete        | Custom  | `scale_<color/fill>_manual(values = c(....))` 
|Continuous, sequential      | Custom  | `scale_<color/fill>_gradient(low = <low color>, high = <high color>)` 
|Continuous, diverging      | Custom  | `scale_<color/fill>_gradient2(low = <low color>, high = <high color>, mid = <mid color>, midpoint = <number>)` 
