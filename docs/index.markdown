...
----------|--------------------------------------------------|-----------------------------|---------------------|-----------------
 ...
 M 11/16 | Introduction to logistic regression | "Logistic regression" RStudio Cloud project  | [Slides in browser](./fall2020/slides/slides_logistic1.html) and [Slides as PDF](./fall2020/slides/slides_logistic1.pdf) | None
