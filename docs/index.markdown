...
T 2/2   | Introduction to R and RStudio, Part 1 | [Introduction to R tutorial](./tutorials/introduction_to_R.html) <br><br> [Exercises: Introduction to R Set 1](https://rowanbiosci.shinyapps.io/intro_R/) | **Homework 1 due** on Canvas as a PDF file. [Link to instructions](./homeworks/hw1/hw1_instructions.html)
W 2/3   | Introduction to R and RStudio, Part 2 | [Exercises: Introduction to R Sets 1-5](https://rowanbiosci.shinyapps.io/intro_R/) | None
