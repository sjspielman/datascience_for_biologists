...
T 2/9   | Introduction to R and RStudio, Part 4 | Exercises: Finish Introduction to R <br><br>[**Link if your last name is A-N**](https://rowanbiosci.shinyapps.io/intro_R/) <br><br>[**Link if your last name is M-Z**](https://rowanbiosci.shinyapps.io/intro_R_M-Z/)| **Homework 2 due** on Canvas as an R script. [Link to instructions](./homeworks/hw2/hw2_instructions.html) 
