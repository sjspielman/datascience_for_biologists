...
----------|--------------------------------------------------|-----------------------------|---------------------|-----------------
 ...
 R 10/29 | Working with `dplyr` two-table verbs, and more data tidying with `tidyr` | [Reference](https://stat545.com/multiple-tibbles.html#bind) | None |  **Assignment #8: hw8.R script due Thursday 11/12/20 (TWO WEEKS!) by 12:01 pm (noon) to Canvas.**  [Link to instructions](./fall2020/assignments/hw8/hw8_instructions.html) and [Template hw5.R script](./fall2020/assignments/hw8/hw8.R) (if needed)
