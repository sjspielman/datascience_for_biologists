...
----------|--------------------------------------------------|-----------------------------|---------------------|-----------------
 ...
 W 10/21 | Tidying data with `tidyr` | We will work on HW7 in class together. | [Pivoting vignette (more advanced)](https://tidyr.tidyverse.org/articles/pivot.html) | **Assignment #7: hw7.R script due Thursday 10/29/20 by 12:01 pm (noon) to Canvas.** [Link to instructions](./fall2020/assignments/hw7/hw7_instructions.html) and [Template hw7.R script](./fall2020/assignments/hw7/hw7.R) (if needed)
