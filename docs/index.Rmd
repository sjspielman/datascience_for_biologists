...
W 9/29 | More `ggplot2`  | ["Introduction to `ggplot2`" exercises](./exercises/ggplot2.html) <br> ["Line-by-line" application](https://sjspielman.shinyapps.io/line_by_line) | Homework 3: Grammar of Graphics <br> [Link to Instructions](./homeworks/hw3/hw3_instructions.html) <br> [Link to Answer Sheet](./homeworks/hw3/homework3_answer_sheet.docx)
