...
M 10/11 | Reading and writing data  |See Canvas for spreadsheet links <br> [Download in-class activity](https://github.com/sjspielman/datascience_for_biologists/raw/master/docs/inclass/mammals_activity.zip) |  [Background reading: "FILE NOT FOUND"](https://www.theverge.com/22684730/students-file-folder-directory-structure-education-gen-z)
W 10/13 | Reading and writing data <br> Introduction to data wrangling | ["Introduction to `dplyr`" exercises](./exercises/dplyr.html) <br> ["Line-by-line" application](https://sjspielman.shinyapps.io/line_by_line) | Homework 5: Exploratory data analysis with `ggplot2` <br> [Link to instructions](./homeworks/hw5/hw5_instructions.html)
...
W 10/20 | `dplyr` and `tidyr` III | -  | Homework 6: Introduction to data wrangling and visualization
