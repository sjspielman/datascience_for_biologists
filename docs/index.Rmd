...
W 10/13 | `dplyr` and `tidyr` II | "Introduction to `dplyr`" exercises <br> ["Line-by-line" application](https://sjspielman.shinyapps.io/line_by_line)  | Homework 5: More data visualization with `ggplot2`
R 10/14 | _Open work day_ | | -
M 10/18 | `dplyr` and `tidyr` III | Slides, TBD | -
W 10/20 | `dplyr` and `tidyr` IV |  "Introduction to `dplyr`" exercises <br> ["Line-by-line" application](https://sjspielman.shinyapps.io/line_by_line)  | Homework 6: Data wrangling and visualization
