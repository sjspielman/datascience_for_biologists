...
R 9/2   | Types of data and figures | "Types of data and figures" interactive exercises | Create a _free_ account on [RStudio Cloud](https://rstudio.cloud)
...
T 9/21 | The grammar of graphics, Part 1 | | Homework 3: Using R and RMarkdown <!-- <br> [Link to Instructions](./homeworks/hw3/hw3_instructions.html) -->
W 9/22 | The grammar of graphics, Part 2 <br> Introduction to `ggplot2` | | -
R 9/23 | _Open work day_  | | -
T 9/28 | More `ggplot2` |  | Homework 4: Grammar of Graphics <!-- <br> [Link to Instructions](./homeworks/hw4/hw4_instructions.html) <br> [Link to Answer Sheet](./homeworks/hw4/homework4_answer_sheet.docx) -->
W 9/29 | More `ggplot2`  | | -
