...
W 10/6 |  Customizing your plots in `ggplot2` | -  |Watch Part 6 video playlist (~1 hour) from "Calling Bullshit": <br> [Link from "Calling Bullshit" class website](https://www.callingbullshit.org/videos.html) <br> [Direct YouTube link](https://www.youtube.com/watch?v=T-5aLbNeGo0) <br><br> Homework 4: Data visualization with `ggplot2`<br> [Link to Instructions](./homeworks/hw4/hw4_instructions.html)
R 10/7 |  _Open work day_ | - | -
M 10/11 | Introduction to data wrangling with `dplyr` and `tidyr` I | Slides, TBD | -
W 10/13 | `dplyr` and `tidyr` II | ["Introduction to `dplyr`" exercises](./exercises/dplyr.html) <br> ["Line-by-line" application](https://sjspielman.shinyapps.io/line_by_line)  | Homework 5: Exploratory data analysis with `ggplot2` <br> [Link to instructions](./homeworks/hw5/hw5_instructions.html)
R 10/14 | _Open work day_ | | -
M 10/18 | `dplyr` and `tidyr` III | Slides, TBD | -
W 10/20 | `dplyr` and `tidyr` IV |  ["Introduction to `dplyr`" exercises](./exercises/dplyr.html) <br> ["Line-by-line" application](https://sjspielman.shinyapps.io/line_by_line)  | Homework 6: Data wrangling and visualization
