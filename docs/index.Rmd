...
W 10/13 | `dplyr` and `tidyr` II | ["Introduction to `dplyr`" exercises](./exercises/dplyr.html) <br> ["Line-by-line" application](https://sjspielman.shinyapps.io/line_by_line)  | Homework 5: More data visualization with `ggplot2`
