...
W 10/6 |  Critiquing data viz <br> Customizing your plots in `ggplot2` | [Set 6 of "Introduction to `ggplot2`" exercises](./exercises/ggplot2.html)  | Watch Part 6 video playlist (~1 hour) from "Calling Bullshit": <br> [Link from "Calling Bullshit" class website](https://www.callingbullshit.org/videos.html) <br> [Direct YouTube link](https://www.youtube.com/watch?v=T-5aLbNeGo0) <br><br> Homework 4: Data visualization with `ggplot2`<br> [Link to Instructions](./homeworks/hw4/hw4_instructions.html)
