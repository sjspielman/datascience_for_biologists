...
R 10/14 | Data wrangling with `dplyr` and `tidyr` II | - | -
M 10/18 | Data wrangling with `dplyr` and `tidyr` III | [Introduction to `dplyr` exercises Sets 1-2](./exercises/dplyr.html) | -
W 10/20 | Data wrangling with `dplyr` and `tidyr` IV | [Introduction to `dplyr` exercises Set 3 1-2](./exercises/dplyr.html) | Homework 6: Introduction to data wrangling and visualization <br> [Link to instructions](./homeworks/hw6/hw6_instructions.html)
R 10/21 | Introducing `#tidytuesday` extra credit  |- | -
M 10/25 | Data wrangling with `dplyr` and `tidyr` V  | | -
