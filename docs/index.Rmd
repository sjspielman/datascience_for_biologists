...
W 11/24 | **CLASS IS OVER ZOOM TODAY!!** <br> Introduction to Final Project <br> <br> [Link to instructions](./homeworks/project/project_proposal_instructions.html) <br> [Link to Rmd template](./homeworks/project/proposal_template.Rmd)  | Homework 11: Logistic regression  <br>  [Link to instructions](./homeworks/hw11/hw11_instructions.html)
R 11/25 | _No class: Thanksgiving_  | - | 
M 11/29 | UNIX, continued | Cheatsheets TBD | -
W 12/1 | UNIX and Github | Cheatsheets TBD | Homework 12: Final Project Proposal. _This homework may NOT be dropped._ <br> (The below links are the same as those shown on 11/24) <br> [Link to instructions](./homeworks/project/project_proposal_instructions.html) <br> [Link to Rmd template](./homeworks/project/proposal_template.Rmd) 
