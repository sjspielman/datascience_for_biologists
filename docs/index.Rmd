...
W 10/20 | Data wrangling with `dplyr` and `tidyr` IV | [Introduction to `dplyr` exercises Sets 1-3](./exercises/dplyr.html) <br> Introducing `#tidytuesday` extra credit | Homework 6: Introduction to data wrangling and visualization <br> [Link to instructions](./homeworks/hw6/hw6_instructions.html)
