...
T 4/20  | Version control with git(hub), Part 1 | [Git command reference](./docs/tutorials/github_reference.html) | **Homework 11 due**  on Canvas as an RMarkdown file. Instructions are embedded as part of the template. <!-- logistic -->
