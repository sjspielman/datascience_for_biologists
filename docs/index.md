...
W 3/3   | Data wrangling with `dplyr`, Part 2. <br> *Note: There is no recording from today's class.* <!-- mutate, arrange, distinct, select --> | [Exercises: Introduction to data wrangling with `dplyr` Set 1-2](https://rowanbiosci.shinyapps.io/intro_dplyr)| None 
...
W 3/10  | Data wrangling with `dplyr`, Part 4 | [PDF Slides](./slides/dplyr_slides_part2.pdf) <br><br> [Slides in browser](./slides/dplyr_slides_part2.html) <br><br> Exercises: Introduction to data wrangling with `dplyr` Set3 | None
...
R 4/22  | Final project setup | [Setup instructions](./homeworks/project/setup_instructions.html) <br><br> *Note that there are some additional setup steps beyond this we will do in class, but this is the foundation.* |  None
...
W 4/28  | *Office hours. Dr. Spielman will be in the Zoom from 2-4:45. Come any time and ask questions or use this time and space to work to get questions addressed when they come up.* | None | None 
R 4/29  | *Office hours. Dr. Spielman will be in the Zoom from 2-4:45. Come any time and ask questions or use this time and space to work to get questions addressed when they come up.*   | None | **Please note that class today is very likely the last chance to speak with me about your project. I cannot guarantee any availability after the semester ends.**
