...
- Weekly homeworks due **every Tuesday at 1 pm**. (65% of final grade, drop the lowest score)
...
<br><br>
- Classes will always be recorded, but technical difficulties can happen leading to "lost" lecture records. This has happened before, and it might happen again. 
<br><br>
- THERE ARE NO EXAMS OR QUIZZES.
<br><br>
- Weekly extra credit opportunities starting in October
...
<br><br>
- Office hours will be on Zoom every **Monday 2:30-4 PM**
  - One Zoom to rule them all
  - No appointment necessary
  - But, we also have *in-person office hours embedded into class.*
<br><br>
...
---
# Communicating with Dr. Spielman 

- Email _availability_ hours are Monday-Thursday 8 am-6 pm and Friday 8 am-4pm
<br><br>
- If you write an email, please make sure it is *professional*
  - Opens with an address ("Dear Dr. Spielman", "Hi Professor", etc.)
  - if you are requesting help with code, I need *all the information*
...
<br><br>
- Should we have a Slack or discord?
...
**I cannot directly teach you these skills. I can only provide you with the environment, resources, and support for you to master them yourselves. This class provides that opportunity!_**
