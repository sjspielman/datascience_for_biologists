...
> Due Thursday 4/22/21 by 11:59 PM. Timely submission is extremely important so that you can begin your final project as soon as possible. You will be able to resubmit the proposal for a full regrade if I do not approve it. Late penalties will not kick in until Monday 4/26 to allow re-submissions without penalty over the weekend, as needed. _Please, do not treat 4/26 as the actual deadline. It will backfire._
