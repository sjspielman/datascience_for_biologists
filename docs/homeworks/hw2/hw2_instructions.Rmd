...
1. Define a _character_ variable named `sport` as the value of a string containing your favorite sport (or other activity if you hate sports!). Print the variable.
