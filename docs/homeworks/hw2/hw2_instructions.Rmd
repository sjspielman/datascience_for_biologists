...
date: "Due as an RScript to Canvas on Tuesday 2/9/21"
output: 
  html_document:
    theme: lumen
---
...
Answer the following questions with R code in the `hw2_template.R` templated script. Please do NOT modify the template but answer questions. 
