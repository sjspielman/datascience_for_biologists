...
date: "Submit this completed Rmd file to Canvas on Wednesday 10/2-0/21 by 2 PM"
output: 
  html_document:
    theme: lumen
    highlight: tango
...
# Define path to figures directory below:

# Define path to the coffee_ratings.csv file below, using `path_to_datasets` as part of the code:

# Read in the dataset and save to a variable coffee_ratings:
