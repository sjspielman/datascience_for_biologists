---
title: "Homework #1: Due Tuesday 9/14/21 to Canvas as a PDF by 11:59 pm"
...
+ If the data is _not_ tidy, _state_ which of the two qualities of tidy data are violated. Note that both can be violated! You can simply use **1** and **2** to refer to the qualities, as described below...
